...
PESDir="/home/bijit/F+H2/AB-INITIO/SURFACE/RHO_10.0/PESMan/GeomData"

RunDir="/home/bijit/F+H2/AB-INITIO/SURFACE/RHO_10.0/PESMan/RunDir"                      #do not put '/' at the end of any path

mkdir -p $RunDir

ResDir="/home/bijit/F+H2/AB-INITIO/SURFACE/RHO_10.0/PESMan/Result_files_Multi"
...
do
  ...
  #./PESMan.py export -j 1 --calc-id 1 --depth 3 --constraint "tags like '%linear%'" 2>> error_export.log
  ...
  ./ExtractGeomIDs.py ImpDir/$CJDir
   ...
   if [ "$NTR" -gt 38 ]; then
       ...
       ./PESMan.py import -e ImpDir/$CJDir/export.dat 2>> error_import.log
